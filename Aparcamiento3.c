...
void main() {
	...
	struct plaza Plaza1 = { 0,'C',"inicia" };
	struct plaza Plaza2 = { 0,'C',"inicia" };
	struct plaza Plaza3 = { 0,'M',"inicia" };
	...
	while (salir==0) {
		...
		case 'R':
			...
			if (Plaza1.estado == 0 && strcmp(tipo, "coche") == 0) {
			...
			if (Plaza2.estado == 0 && strcmp(tipo, "coche") == 0) {
			...
			if (Plaza3.estado == 0 && strcmp(tipo, "moto") == 0) {
			...
			if (Plaza1.estado == 1 && Plaza2.estado == 1 && Plaza3.estado == 1) {
		...
		case 'B':
			...
			if (strcmp(Plaza1.matricula, matriculaaux) == 0) {
			...
			else if (strcmp(Plaza2.matricula, matriculaaux) == 0) {
			...
			else if (strcmp(Plaza3.matricula, matriculaaux) == 0) {
